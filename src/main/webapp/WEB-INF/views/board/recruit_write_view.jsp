...
<script type="text/javascript">
	$(function() {
		CKEDITOR.replace('rb_content', {
			filebrowserUploadUrl : '${conPath }/rbWriteFileupload.do'
		});
	});
</script>
<script>
...
<body>
	...
	<div id="content_wrap">
	<form action="${conPath }/rbWrite.do"  method="post" enctype="multipart/form-data">	
		<table class="table is-striped is-narrow is-hoverable">
			<caption>글쓰기</caption>
			<tbody>
				<tr>
					<th>글제목</th>
					<td><input type="text" name="rb_name" class="rb_name"></td>
				</tr>
				<tr id="write_area">
					<th>본문</th>
					<td>
