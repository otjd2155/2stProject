	   ...
	   $('#booking').click(function(){
		...
		$('#modal_opne_btn').click(function(){
			...
			if($("#r_no").val()==''){	
				...
				$.ajax({
				   	url : '${conPath }/bookingViewModal.do',
					dataType : "html",
					data : 'r_no='+r_no,
					success : function(data){
	...
	<table>
		<tbody>
		    ...
		    <tr>
		    	...
		    	<td>
		    		<span id="uname">${users.u_name } (${users.u_id })</span>
		    	</td>
		    </tr>
		    </c:if>
			<tr>
				...
				<td>
					...
					<a id="modal_opne_btn"><span style="color:#ffb400; font-weight: bold;"> 방 정보</span> </a>	
				</td>
			</tr>
			<tr>
				<td class="td1">
