...
public class Book {
	...
	public int getBk_rv_status() {
		return bk_rv_status;
	}

	public void setBk_rv_status(int bk_rv_status) {
		this.bk_rv_status = bk_rv_status;
	}
	...
	public String toString() {
		return "Book [bk_no=" + bk_no + ", bk_date=" + bk_date + ", bk_stime=" + bk_stime + ", bk_status=" + bk_status
				...
				+ ", bk_rv_status=" + bk_rv_status + ", startRow=" + startRow + ", endRow=" + endRow + ", schItem="
				+ schItem + ", schWord=" + schWord + ", u_id=" + u_id + ", r_no=" + r_no + ", subscriber=" + subscriber
				+ ", roomname=" + roomname + "]";
	}
