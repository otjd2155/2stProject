...
<body>
	<c:if test="${not empty resultuidfail }">
		<script>
			alert('${resultuidfail}');
		</script>
	</c:if>
			...
			<div class="left">
				<form action="${conPath}/idfind.do" method="get">
					...
					<fieldset>
						...
						<ul id="u_findId">
							<li>&nbsp;</li>
							<li><label class="li1">입력한 이메일</label><input type="text" class="u_email" placeholder="이메일주소를 입력해주세요"
								name="u_email" autocomplete="off"/>
							<li>
							<li><label class="li2">이름</label><input type="text" class="u_name" placeholder="한글 또는 영문으로 입력해주세요"
