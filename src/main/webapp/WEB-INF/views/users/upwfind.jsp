				...
				<fieldset>
					...
					<ul id="u_findId">
						...
						<li><label class="li3">아이디</label><input type="text"
							class="u_id" name="u_id" placeholder="아이디를 입력해주세요." value="${u_id }" autocomplete="off"><span style="color: red;">${resultId}</span>
						<li>
						<li><label class="li3">이메일</label><input type="text"
							class="u_email" name="u_email" placeholder="이메일을 입력해주세요."
							value="${u_email }" autocomplete="off"><span style="color: red;">${resultEmail}</span>
						<li>
						<li>&nbsp;</li>
					</ul>
				</fieldset>
