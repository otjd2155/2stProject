			...
			<div class="footer_div">
				<div class="container clearfix">
					<div class="col-one-forth">
						...
						<a href="${conPath }/introCafe.do">Read More <span><i class="fas fa-caret-right"></i></span></a>
					</div>
					<div class="col-one-forth">
						<h3>Come to US</h3>
					...
					<div class="col-one-forth">
						...
						<ul class="phone">
							...
							<c:if test="${empty sessionScope.admin || empty sessionScope.users}"><li><a href="${conPath}/admin/adminLoginView.do">관리자로그인</a></li></c:if>
