	     ...
	     var phonePattern = /(^02.{0}|^01.{1}|[0-9]{3})([0-9]+)([0-9]{4})/g;
			$('.u_id').keyup(function(){
				...
				if(!idPattern.test($('.u_id').val())) {
					$('#idConfirmResult').html('불가능한 ID입니다.');
				}else{
					$.ajax({
			...
			<form action="${conPath }/join.do" method="post"
				...
				<caption><span id="caption_big">회원정보입력</span> <span id="caption_small"> *는 필수입력 항목입니다.</span></caption>
					...
					<tr>
						...
						<td colspan="2" class="not_height"><input type="password" name="u_pw" class="u_pw" placeholder="비밀번호를 입력해주세요."> <span id="pwResult"></span><br>
