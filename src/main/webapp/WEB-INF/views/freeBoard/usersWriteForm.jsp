...
<body>
	...
	<div id="content_wrap">
		<form action="${conPath }/userWrite.do"  method="post" enctype="multipart/form-data">	
		...
		<table class="table is-striped is-narrow is-hoverable">
			...
			<tbody>
				<tr>
					<th>작성자</th>
					<td><input type="text" name="u_nickname" value="${u_nickname }" readonly="readonly"></td>
				</tr>
				<tr>
					<th>글제목</th>
				...
				<tr id="write_area">
					<th>본문</th>
					<td><textarea rows="5" id="fb_content" cols="30" name="fb_content"></textarea>
				</tr>
			</tbody>
		</table>
