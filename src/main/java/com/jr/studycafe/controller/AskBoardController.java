...
public class AskBoardController {
	...
	public String askboardList(Model model, AskBoard askboard, String pageNum) {
		    int pageSize = 10;
	        int blockSize = 10;
	        int totCnt = askBoardService.ask_boardcnt(askboard);
	        Paging paging = new Paging(totCnt, pageNum, pageSize, blockSize);
	...
	public String askWriteView(Model model, String u_id, String u_name, String pageNum, String a_id, String a_name) {
