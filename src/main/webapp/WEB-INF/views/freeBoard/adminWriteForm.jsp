...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$('form').submit(function(){
			 ...
			 if(CKEDITOR.instances.fb_content.getData().length < 1){
					alert("본문입력 필수");
			        $('#fb_content').focus();
			         return false;
			 }
...
<body>
	...
	<div id="content_wrap">
		<form action="${conPath }/adminWrite.do"  method="post" enctype="multipart/form-data">	
		<input type="hidden" value="${a_id }" name="a_id" id="a_id">
		<table class="table is-striped is-narrow is-hoverable">
			<caption>글쓰기</caption>
			<tbody>
				<tr>
					<th>작성자</th>
					<td><input type="text" name="a_name" value="${a_id }" readonly="readonly"></td>
				</tr>
				<tr>
					<th>글제목</th>
					<td><input type="text" id="fb_name" name="fb_name"></td>
				</tr>
				<tr id="write_area">
					<th>본문</th>
					<td><textarea rows="5" cols="30" id="fb_content" name="fb_content"></textarea>
				</tr>
			</tbody>
		</table>
