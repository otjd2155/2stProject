	...
	<input type="hidden" value="${u_name }">
		...
		<table class="table is-striped is-narrow is-hoverable">
			...
			<tbody>
				<tr>
					<th>작성자</th>
					<td><input type="text" name="u_name" readonly="readonly" value="${users.u_name }"></td>
				</tr>
				<tr>
					<th>제목</th>
					<td><input type="text" name="ab_name" required="required"></td>
				</tr>
				<tr id="write_area">
					<th>문의내용</th>
		...
		<table id="table_bottom">
			<tr>
				<td><input type="submit" value="문의하기"
